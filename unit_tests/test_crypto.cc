...
#define TEST_MURMUR32(text, value) REQUIRE(crypto::murmur32(text, sizeof(text) - 1) == value)//console::log("crypto::murmur(\"" text "\") = 0x%lx", crypto::murmur(text, sizeof(text)))
...
TEST_CASE("crypto module testing", "[crypto]")
{
    ...
    TEST_MURMUR32("hello world", 1586663183);
    TEST_MURMUR32("Hello World", 427197390);
