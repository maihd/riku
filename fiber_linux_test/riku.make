...
ifeq ($(config),debug32)
  OBJDIR              = ../build/linux_x32/fiber_test/obj/x32/debug/riku
  TARGETDIR           = ../build/linux_x32/fiber_test/bin
...
ifeq ($(config),release32)
  OBJDIR              = ../build/linux_x32/obj/x32/release/riku
  TARGETDIR           = ../build/linux_x32/bin
...
ifeq ($(config),debug64)
  OBJDIR              = ../build/linux_x64/obj/x64/debug/riku
  TARGETDIR           = ../build/linux_x64/bin
  TARGET              = $(TARGETDIR)/libriku.debug.a
  DEFINES            += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D_DEBUG
  INCLUDES           += -I"../include" -I"../3rdparty/zlib-1.2.11"
  ALL_CPPFLAGS       += $(CPPFLAGS) -MMD -MP -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),release64)
  OBJDIR              = ../build/linux_x64/obj/x64/release/riku
  TARGETDIR           = ../build/linux_x64/bin
  TARGET              = $(TARGETDIR)/libriku.a
  DEFINES            += -DNDEBUG
  INCLUDES           += -I"../include" -I"../3rdparty/zlib-1.2.11"
...
$(OBJDIR)/src/riku_alloc.o: ../src/riku_alloc.cc $(GCH) $(MAKEFILE) | $(OBJDIR)/src
	@echo $(notdir $<)
